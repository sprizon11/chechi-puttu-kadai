...
export default function Customers() {
  ...
  useEffect(() => {
    ...
    const unsub1 = onSnapshot(query(collection(db, 'users'), limit(500)), snap => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {filtered.map(u => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-gray-500 text-xs">
                      {u.lastOrder ? format(u.lastOrder, 'd MMM yyyy') : '—'}
                    </td>
                  </tr>
                ))}
                {filtered.length === 0 && (
        ...
        {selectedUser && (
          <div className="section-card p-6 space-y-5">
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-maroon/10 flex items-center justify-center text-maroon font-bold text-xl">
            ...
            <div>
              ...
              <div className="space-y-2 max-h-52 overflow-y-auto">
                {selectedUser.userOrders.slice(0, 10).map(o => {
                  ...
                  return (
                    <div key={o.id} className="flex justify-between text-xs py-1.5 border-b border-cream-border">
